...
;;; Auto-execute section
    ...
    InfoTeamSize := "Select how many champions in your team."
    ...
    Gui, Main:Add, DropDownList, Section w55 vRankSelector gOnCalculatorChanged Choose%selectedRank% AltSubmit, %RankOptions%
    Gui, Main:Add, DropDownList, ys w30 vTeamSizeSelector gOnCalculatorChanged Choose%selectedTeamSize% AltSubmit, %TeamSizeOptions%
    Gui, Main:Add, Text, ys h20 %SS_CENTERIMAGE% Center,  champions from lvl
...
OnCalculatorChanged:
    ...
    GuiControlGet,TeamSizeValue,,TeamSizeSelector
    ...
    IniWrite, %TeamSizeValue%, %SettingsFilePath%, %SettingsSection%, teamSize
    ...
    Settings.teamSize := TeamSizeValue
...
InitSettings(){
    ...
    selectedTeamSize := Settings.teamSize
